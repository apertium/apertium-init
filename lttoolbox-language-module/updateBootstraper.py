...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--bootstraperScript', help='Location of bootstraper script', default='./bootstrap.py')
    ...
    for line in fileinput.input([args.bootstraperScript], inplace=True):
        sys.stdout.write(re.sub(r'^files = {.*?}$', 'files = %s' % repr(encodedFiles), line))
